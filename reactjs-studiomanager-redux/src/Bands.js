...
function Bands()
{
  // const bandReducer = useSelector(state => state.bandReducer);
    ...
    return (
      <div className="container" style={{marginTop}}>
            ...
            <div className="row">
              ...
              { bandReducer.bands.map(band => <Band band_name={band.band_name} genre={band.genre} id={band.id} key={band.id} handleDeleteBand={this.handleDeleteBand} />) }
            </div>
      </div>
    )
  // }
